...
var complete = false; // turn true after test
var score = 0;
var questionsAnswered = 0; // counter for number of questions answered
var status; // convert boolean to 'correct' or 'incorrect'
var response; //user response
var numChoices = 4; // stores how many choices each question
var questions = [
...
var answered; //whether the user answered the question
